...
@ComponentScan(basePackages = { "com.kinexcs.demo.getway.application", "com.kinexcs.demo.getway.controller" })
@ApiIgnore
@EnableSwagger2
public class AppConfiguration {
	private static final Logger LOGGER = LoggerFactory.getLogger(AppConfiguration.class);
	private static final String SERVICE_NAME = "GETWAY_MS";
	...
	public String home() {
		return "GETWAY-MS is Up and Running";
	}
	...
	public FilterRegistrationBean loggingFilter() {
		...
		registrationBean.addUrlPatterns("/getway/*");
		return registrationBean;
	}

	@Bean
	public Docket api() {
		ApiInfo apiInfo = new ApiInfo("GETWAY - MS => REST API", "Spring Boot REST API for GETWAY", "1.0.0", "Terms of service", new Contact(
