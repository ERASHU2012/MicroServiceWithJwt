package com.kinexcs.demo.order.application;
...
@ComponentScan(basePackages = { "com.kinexcs.demo.order.application", "com.kinexcs.demo.order.controller" })
@EntityScan(basePackages = "com.kinexcs.demo.order.entity")
@ApiIgnore
@EnableSwagger2
@EnableJpaRepositories(basePackages = "com.kinexcs.demo.order.repo")
